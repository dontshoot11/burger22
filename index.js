...
let verticalMenuListLink = document.querySelectorAll('.vertical-menu-list__link');
for (let i = 0; i < verticalMenuListLink.length; i++) { verticalMenuListLink[i].addEventListener('click', function() { wallpaperFullscreen.style.right = '-100%' }) }
